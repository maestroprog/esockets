...
final class Event
{
    ...
    public function detachListener(int $uid): void
    {
     ...
     * @return void
     */
    public function clearListeners(bool $notSubscribedOnly = false): void
    {
     ...
     */
    private function clearNotSubscribedListeners(): void
    {
